...
export const Button = ({ variant = "green", text, url }: AtButtonProps) => {
  return (
    <a
      ...
      className={cn(
        "font-extralight text-xl max-w-full h-full px-12 py-4 bg-neutral-800 rounded-md border-2 flex-row justify-center items-center gap-3.5 inline-flex hover:shadow-lg",
